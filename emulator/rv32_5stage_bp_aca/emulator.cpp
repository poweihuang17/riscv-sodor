...
//   disassembler disasm;
   ...
   //MODIFIED. Add Branch Predictor
   struct bp_io bpio;
   bpio.if_pc_reg_ptr          = &dut.Top_tile_core_d__if_reg_pc;
   ...
   bpio.if_pred_taken_ptr      = &dut.Top_tile_core_d_btb__btb_reg_dummy_pred_taken;
   bpio.if_pred_target_ptr     = &dut.Top_tile_core_d_btb__btb_reg_dummy_pred_target;
